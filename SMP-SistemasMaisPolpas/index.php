...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('vendor/login/images/teste1.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					<img src="img/logot.png" width="100">
				</span>
				<form class="login100-form validate-form p-b-33 p-t-5" method="POST" action="autenticar.php">
					...
					<div class="container-login100-form-btn m-t-32">
						<button type="submit" class="login100 btn btn-warning">
							Entrar
						</button>
					</div>
